							...
							<block>
								...
								<view class="item-middle">
									<view style="display: flex;">
										...
										<image v-if="it.friendInfo.authType == 1 || it.friendInfo.authType == 2" src="../static/icon/auth.png" style="width: 18px; height: 15px;margin-top: 3px;margin-left: 3px;"></image>
									</view>
