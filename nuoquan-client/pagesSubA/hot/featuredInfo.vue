<template>
	<view  style="width:100%;">
		...
		<block v-for="(thisArticle,index) in myArticleList" :key="thisArticle.articleId">
			<view class="oneArticle" @click="goToDetail(thisArticle)">
				<image class="index" src="../../static/goTop.jpg"></image>
	...
	export default {
		...
		methods:{
				goToDetail:function(thisArticle){
					...
					uni.navigateTo({
						url: '/pagesSubA/detail/detail?data=' + thisArticle.articleId
					});
				},
