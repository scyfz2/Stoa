...
/**
 * 功德领取记录表 MeriHistoryExample
 * @author fuce_自动生成
 * @date 2023-08-21 20:46:05
 */
public class MeriHistoryExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andMeritLike(Integer value) {
            addCriterion("merit like", value, "merit");
            return (Criteria) this;
        }

        public Criteria andMeritNotLike(Integer value) {
        ...
        public Criteria andIsDeletedNotBetween(Character value1, Character value2) {
		 ...
		 public Criteria andLikeQuery(MeriHistory record) {
			...
			if(record.getDate()!=null&&StrUtil.isNotEmpty(record.getDate().toString())) {
    			 list.add("ifnull(date,'')");
    		}
			if(record.getMerit()!=null&&StrUtil.isNotEmpty(record.getMerit().toString())) {
    			 list.add("ifnull(merit,'')");
    		}
			...
			if(record.getDate()!=null&&StrUtil.isNotEmpty(record.getDate().toString())) {
    			list2.add("'%"+record.getDate()+"%'");
    		}
			if(record.getMerit()!=null&&StrUtil.isNotEmpty(record.getMerit().toString())) {
    			list2.add("'%"+record.getMerit()+"%'");
    		}
			if(record.getIsDeleted()!=null&&StrUtil.isNotEmpty(record.getIsDeleted().toString())) {
