...
/**
 * 排行榜评论点亮表 LeaderBoardTagExample
 * @author xxdd_自动生成
 * @date 2023-12-23 15:05:39
 */
public class LeaderBoardTagExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andDelFlagNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(LeaderBoardTag record) {
			...
			if(record.getTagName()!=null&&StrUtil.isNotEmpty(record.getTagName().toString())) {
    			 list.add("ifnull(tag_name,'')");
    		}
			if(record.getExtend1()!=null&&StrUtil.isNotEmpty(record.getExtend1().toString())) {
    			 list.add("ifnull(extend1,'')");
    		}
			...
			if(record.getTagName()!=null&&StrUtil.isNotEmpty(record.getTagName().toString())) {
    			list2.add("'%"+record.getTagName()+"%'");
    		}
			if(record.getExtend1()!=null&&StrUtil.isNotEmpty(record.getExtend1().toString())) {
    			list2.add("'%"+record.getExtend1()+"%'");
    		}
			if(record.getCreateBy()!=null&&StrUtil.isNotEmpty(record.getCreateBy().toString())) {
