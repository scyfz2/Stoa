...
/**
 * 排行榜评论表 LeaderBoardEvaluateExample
 * @author xxdd_自动生成
 * @date 2023-12-23 15:05:35
 */
public class LeaderBoardEvaluateExample {
    ...
    public LeaderBoardEvaluateExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andLeaderBoardObjectIdIsNull() {
            addCriterion("leader_board_object_id is null");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdIsNotNull() {
            addCriterion("leader_board_object_id is not null");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdEqualTo(Long value) {
            addCriterion("leader_board_object_id =", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdNotEqualTo(Long value) {
            addCriterion("leader_board_object_id <>", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdGreaterThan(Long value) {
            addCriterion("leader_board_object_id >", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdGreaterThanOrEqualTo(Long value) {
            addCriterion("leader_board_object_id >=", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdLessThan(Long value) {
            addCriterion("leader_board_object_id <", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdLessThanOrEqualTo(Long value) {
            addCriterion("leader_board_object_id <=", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdLike(Long value) {
            addCriterion("leader_board_object_id like", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdNotLike(Long value) {
            addCriterion("leader_board_object_id not like", value, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdIn(List<Long> values) {
            addCriterion("leader_board_object_id in", values, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdNotIn(List<Long> values) {
            addCriterion("leader_board_object_id not in", values, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdBetween(Long value1, Long value2) {
            addCriterion("leader_board_object_id between", value1, value2, "leaderBoardObjectId");
            return (Criteria) this;
        }

        public Criteria andLeaderBoardObjectIdNotBetween(Long value1, Long value2) {
            addCriterion("leader_board_object_id not between", value1, value2, "leaderBoardObjectId");
            return (Criteria) this;
        }
        ...
        public Criteria andStarNumLike(Integer value) {
            addCriterion("star_num like", value, "starNum");
            return (Criteria) this;
        }

        public Criteria andStarNumNotLike(Integer value) {
            addCriterion("star_num not like", value, "starNum");
            return (Criteria) this;
        }
        ...
        public Criteria andSendDateLike(Date value) {
            addCriterion("send_date like", value, "sendDate");
            return (Criteria) this;
        }

        public Criteria andSendDateNotLike(Date value) {
        ...
        public Criteria andDelFlagNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(LeaderBoardEvaluate record) {
			...
			if(record.getLeaderBoardObjectId()!=null&&StrUtil.isNotEmpty(record.getLeaderBoardObjectId().toString())) {
    			 list.add("ifnull(leader_board_object_id,'')");
    		}
			...
			if(record.getEvaluateDesc()!=null&&StrUtil.isNotEmpty(record.getEvaluateDesc().toString())) {
    			 list.add("ifnull(evaluate_desc,'')");
    		}
			if(record.getStarNum()!=null&&StrUtil.isNotEmpty(record.getStarNum().toString())) {
    			 list.add("ifnull(star_num,'')");
    		}
			if(record.getSendDate()!=null&&StrUtil.isNotEmpty(record.getSendDate().toString())) {
    			 list.add("ifnull(send_date,'')");
    		}
			...
			if(record.getLeaderBoardObjectId()!=null&&StrUtil.isNotEmpty(record.getLeaderBoardObjectId().toString())) {
    			list2.add("'%"+record.getLeaderBoardObjectId()+"%'");
    		}
			if(record.getUserId()!=null&&StrUtil.isNotEmpty(record.getUserId().toString())) {
			...
			if(record.getEvaluateDesc()!=null&&StrUtil.isNotEmpty(record.getEvaluateDesc().toString())) {
    			list2.add("'%"+record.getEvaluateDesc()+"%'");
    		}
			if(record.getStarNum()!=null&&StrUtil.isNotEmpty(record.getStarNum().toString())) {
    			list2.add("'%"+record.getStarNum()+"%'");
    		}
			if(record.getSendDate()!=null&&StrUtil.isNotEmpty(record.getSendDate().toString())) {
    			list2.add("'%"+record.getSendDate()+"%'");
    		}
			if(record.getCreateBy()!=null&&StrUtil.isNotEmpty(record.getCreateBy().toString())) {
