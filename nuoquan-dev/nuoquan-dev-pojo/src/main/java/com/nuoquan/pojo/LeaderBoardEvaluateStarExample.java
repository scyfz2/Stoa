...
/**
 * 排行榜评论点亮表 LeaderBoardEvaluateStarExample
 * @author xxdd_自动生成
 * @date 2023-12-23 15:05:37
 */
public class LeaderBoardEvaluateStarExample {
    ...
    public LeaderBoardEvaluateStarExample() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andEvaluateIdLike(Long value) {
            addCriterion("evaluate_id like", value, "evaluateId");
            return (Criteria) this;
        }

        public Criteria andEvaluateIdNotLike(Long value) {
        ...
        public Criteria andDelFlagNotBetween(Integer value1, Integer value2) {
		 ...
		 public Criteria andLikeQuery(LeaderBoardEvaluateStar record) {
			...
			if(record.getEvaluateId()!=null&&StrUtil.isNotEmpty(record.getEvaluateId().toString())) {
    			 list.add("ifnull(evaluate_id,'')");
    		}
			...
			if(record.getEvaluateId()!=null&&StrUtil.isNotEmpty(record.getEvaluateId().toString())) {
    			list2.add("'%"+record.getEvaluateId()+"%'");
    		}
			if(record.getUserId()!=null&&StrUtil.isNotEmpty(record.getUserId().toString())) {
