...
/**
 * 排行榜 RankingListExample
 * @author fuce_自动生成
 * @date 2023-08-21 22:27:35
 */
public class RankingListExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andValueLike(Integer value) {
            addCriterion("value like", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueNotLike(Integer value) {
        ...
        public Criteria andIsDeletedNotBetween(Character value1, Character value2) {
		 ...
		 public Criteria andLikeQuery(RankingList record) {
			...
			if(record.getSort()!=null&&StrUtil.isNotEmpty(record.getSort().toString())) {
    			 list.add("ifnull(sort,'')");
    		}
